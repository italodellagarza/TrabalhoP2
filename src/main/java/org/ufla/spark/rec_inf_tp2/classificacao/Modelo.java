...
public final class Modelo {
	...
	public static final class Builder {
		...
		public Modelo build(JavaSparkContext context, String topic) {
			...
			// NaiveBayes.train(context.parallelize(training.build()).cache().rdd(), 1.0);
	...
	/**
	 * Returns a string with model name and statistics for debugging and testing
	 * purposes.
	 */
	public String toString() {
		return this.topic + " " + pft(this.precision) + " " + pft(this.recall) + " " + pft(this.accuracy) + " "
				+ pft(this.f1);
	}
