...
/**
 * A very simple tokenizer based on Lucene's EnglishAnalyzer.
 */
public final class Tokenizer {

    private static final String[] ENGLISH_STOPWORDS = { "a", "a's", "able", "about", "above", "according", "accordingly",
    ...
    private static final Analyzer ENGLISH_ANALYZER = new EnglishAnalyzer(Version.LUCENE_36, ImmutableSet.copyOf(ENGLISH_STOPWORDS));

    private Tokenizer() { }

    /**
     * Returns a list of tokens for the given document's content.
     */
    public static List<String> getTokens(Documento document) {
        ImmutableList.Builder<String> builder = ImmutableList.builder();

        TokenStream stream = ENGLISH_ANALYZER.tokenStream("", new StringReader(document.getConteudo()));
